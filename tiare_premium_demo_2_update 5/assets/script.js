(() => {
  ...
  const answerFor = (prompt) => {
    ...
    if (q.includes('prezz') || q.includes('tariff') || q.includes('costo')) {
      return 'Le tariffe visibili sono: Doppia Ginestra €70/notte, Doppia Tulipano €100/notte e Tripla Ranuncolo €130/notte. La Suite Lavanda viene gestita con tariffa su richiesta. Per la conferma sulle date, usa il modulo disponibilità.';
    }
